import style from './file-input.css?raw';
import html from './file-input.html?raw';

const COMPONENT_STYLESHEET = new CSSStyleSheet();
COMPONENT_STYLESHEET.replaceSync(style);

const COMPONENT_TAG_NAME = 'file-input';
export class FileInputElement extends HTMLElement
{
...
{
    customElements.define(COMPONENT_TAG_NAME, FileInputElement);
}